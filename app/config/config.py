...
def load_config():
    ...
    if not os.path.isfile(config_file):
        example_file = f"{bundle_root()}/config.example.toml"
...
project_name = _cfg.get("project_name", "Cinemagic")
project_description = _cfg.get(
    "project_description",
    "<a href='https://x.com/NJook31649'>Cinemagic</a>"
    "<br><small>AI short video studio · Author: @NJook31649</small>",
)
project_version = _cfg.get("project_version", "1.1.0")
author_x_url = _cfg.get("author_x_url", "https://x.com/NJook31649")
reload_debug = False
